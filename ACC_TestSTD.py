...
def main(name,feature_extraction,feature_selection,standard,G,dimension,over_sampling):
    ...
    if name == 'Feng':
        for k in range(f1,dimension+1,5):
            ...
            file = open('./result/'+resultname+'_result/'+resultname+'_result_TestSTD.txt', 'a', newline='')  
    ...
    if name == 'Zhang':
        ...
        for k in range(f1,dimension+1,5):
            ...
            bestscore1 = -1
            bestscore2 = -1
            file1 = open('./result/'+resultname+'_result/'+resultname+'_result_Train_TestSTD.txt', 'a', newline='')  
            file2 = open('./result/'+resultname+'_result/'+resultname+'_result_Test_TestSTD.txt', 'a', newline='')  
...
main('Feng',['ACC'],'','Minmax',11,4000,'')
main('Feng',['ACC'],'','Robust',11,4000,'')
main('Feng',['ACC'],'','Standard',11,4000,'')

main('Zhang',['ACC'],'','Minmax',11,4000,'')
main('Zhang',['ACC'],'','Robust',11,4000,'')
main('Zhang',['ACC'],'','Standard',11,4000,'')
