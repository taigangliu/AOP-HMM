...
def main(name,feature_extraction,feature_selection,standard,G,dimension,over_sampling):
    ...
    if name == 'Feng':
        for k in range(f1,dimension+1,5):
            ...
            file = open('./result/'+resultname+'_result/'+resultname+'_result_TestG.txt', 'a', newline='')  
    ...
    if name == 'Zhang':
        ...
        for k in range(f1,dimension+1,5):
            ...
            bestscore1 = -1
            bestscore2 = -1
            file1 = open('./result/'+resultname+'_result/'+resultname+'_result_Train_TestG.txt', 'a', newline='')  
            file2 = open('./result/'+resultname+'_result/'+resultname+'_result_Test_TestG.txt', 'a', newline='')  
...
for i in range(2,12):
    main('Feng',['ACC'],'','',i,400*(i-1),'')
    

for i in range(2,12):
    main('Zhang',['ACC'],'','',i,400*(i-1),'')
